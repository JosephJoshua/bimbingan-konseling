                ...
                <tr>
                  ...
                  <th scope="col" class="px-6 py-3">
                    <div
                      ...
                      @click="() => handleSort('consultation_category')"
                    >
                      Kategori

                      <component
                        :is="getSortIcon('consultation_category')"
                        class="w-4"
                      />
                    </div>
                  </th>
                  ...
                  <th scope="col" class="px-6 py-3">
                    <div
                      class="whitespace-nowrap flex items-center gap-1 cursor-pointer transition-all duration-200 hover:brightness-125"
                      @click="() => handleSort('description')"
                    >
                      Deskripsi

                      <component :is="getSortIcon('description')" class="w-4" />
                    </div>
                  </th>
